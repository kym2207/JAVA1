 ...
 * 설명 : 두개의 정수를 입력받아 두 수 사이의 모든 합과 짝수의 합, 홀수의 합을 출력하시오.
 * 		 합을 계산하는 부분은 Sum() 클래스로 작성합니다.
 * 		 Sum()클래스는 멤버변수와 3개의 메소드로 구성됩니다.
 * 		 각 메소드는 2대의 값을 전달받아 합을 계산하고 그 값을 돌려줍니다.
 * [문제분석]
 * 		3개의 메소드 - 전체 합 계산, 짝수의 합, 홀수의 합
 * 		멤버변수 - Sum => 전역변수 (클래스 안에 메소드 밖에 선언)
 * 		각 메소드에 접근하여 합계를 계산하여면 반드시 객체를 생성해야 한다.
...
public class SumTest01 {
	...
	public static void main(String[] args) {
		...
		System.out.println(num1 + "부터 " + num2 + "까지의 짝수의 합 : " + s.oddSum(num1, num2));
		
		// 입력받은 값은 s 객체를 통해서 Sum 클래스의 evenSum() 메소드로 전달.
		System.out.println(num1 + "부터 " + num2 + "까지의 홀수의 합 : " + s.evenSum(num1, num2));
